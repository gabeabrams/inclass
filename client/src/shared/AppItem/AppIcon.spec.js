...
describe('client > src > shared > AppIcon', () => {
  it('Displays the AppIcon', async () => {
    ...
    assert.equal(driver.getAttributes('.app-icon').src, 'https://www.google.com/search?q=harvard+logo&prmd=isnv&source=lnms&tbm=isch&sa=X&ved=2ahUKEwiv_rCRxsfjAhUFuVkKHf3TAKYQ_AUoAXoECBIQAQ&biw=870&bih=701&dpr=2#imgrc=DYmtqTjJwjBb2M', 'did not use the correct icon url');
